...
# Plotting the different Energy Sub Metering on the same graph - plot3.png
with(powerData, {
...
# Legend does not end up at the set location in RStudio. Works fine in R but seems to be cutting
# the letters - reason for the extra space at the end of the legend names.
